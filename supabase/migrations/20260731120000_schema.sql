-- MangaMarketplace canonical Phase 1 schema - Supabase deployment
-- PostgreSQL 15+
--
-- Shared domain tables match the Supabase deployment. The intentional
-- deployment difference is authentication: Supabase profiles reference
-- auth.users; local profiles reference public.auth_users.
